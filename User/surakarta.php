...
$query = mysqli_query($koneksi, "SELECT 
    ...
    WHERE h.kota_hotel LIKE '%Surakarta%'
    GROUP BY h.id_hotel
...
<head>
    ...
    <title>Surakarta | Javast</title>
    <link rel="stylesheet" href="Surakarta.css">
...
<div class="navbar">
    ...
    <header class="header">
        ...
        <h2>Surakarta</h2>
        <hr>
        <h5>Lihat semua hotel yang ada di kota Surakarta.</h5>
    </header>
    ...
    <br>
        ...
        <?php else: ?>
            <p class="no-results">Tidak ada hotel yang ditemukan di Surakarta.</p>
        <?php endif; ?>
    </div>
