...
$query = mysqli_query($koneksi, "SELECT 
    ...
    WHERE h.kota_hotel LIKE '%Purbalingga%'
    GROUP BY h.id_hotel
...
<head>
    ...
    <title>Purbalingga | Javast</title>
    <link rel="stylesheet" href="Purbalingga.css">
...
<div class="navbar">
    ...
    <header class="header">
        ...
        <h2>Purbalingga</h2>
        <hr>
        <h5>Lihat semua hotel yang ada di kota Purbalingga.</h5>
    </header>
    ...
    <br>
        ...
        <?php else: ?>
            <p class="no-results">Tidak ada hotel yang ditemukan di Purbalingga.</p>
        <?php endif; ?>
    </div>
