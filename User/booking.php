            ...
            <?php while ($transaksi = mysqli_fetch_assoc($result)): ?>
                ...
                <div class="booking-card">
                    ...
                    <?php if ($transaksi['metode_pembayaran'] != 'Bayar di hotel'): ?>
                        <p><b><i class="fa-solid fa-credit-card"></i> Metode pembayaran:</b> <?= htmlspecialchars($transaksi['metode_pembayaran']) ?></p>
                    <?php else:?>
                        <p><b><i class="fa-solid fa-wallet"></i> Metode pembayaran:</b> <?= htmlspecialchars($transaksi['metode_pembayaran']) ?></p>
                    <?php endif; ?>
                    
                    <?php if ($transaksi['metode_pembayaran'] != 'Bayar di hotel'): ?>
                        <p><b><i class="fa-solid fa-image"></i> Bukti Foto:</b> <?= htmlspecialchars(basename($transaksi['upload_bukti'])) ?></p>
                    <?php else:?>
