...
$query = mysqli_query($koneksi, "SELECT 
    ...
    WHERE h.kota_hotel LIKE '%Salatiga%'
    GROUP BY h.id_hotel
...
<div class="navbar">
    ...
    <header class="header">
        ...
        <h2>Salatiga</h2>
        <hr>
        <h5>Lihat semua hotel yang ada di kota Salatiga.</h5>
    </header>
    ...
    <br>
        ...
        <?php else: ?>
            <p class="no-results">Tidak ada hotel yang ditemukan di Salatiga.</p>
        <?php endif; ?>
    </div>
